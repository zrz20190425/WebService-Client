...
public class DemoService_ServiceLocator extends org.apache.axis.client.Service implements test.DemoService_Service {
    ...
    private java.lang.String DemoServiceImplPort_address = "http://localhost:8080/demo/api";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.example.com", "demoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.example.com", "DemoServiceImplPort"));
        }
